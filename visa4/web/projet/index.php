<?php
    ...
    session_start();
}; // cette page utilise les sessions
	include_once 'fonctions.php';
	include_once 'formulaires.php';
	?>
<?php
include 'fonctions.php'; // session_start() est déjà géré ou ici
include 'formulaires.php';

// 1. GESTION DE LA DECONNEXION (Toujours avant le HTML)
if (isset($_GET["action"]) && $_GET["action"] == 'logout') {
    session_destroy();
    $_SESSION = array();
    header("Location: index.php"); // Redirection propre en PHP
    exit();
}
?>
<!DOCTYPE html>
