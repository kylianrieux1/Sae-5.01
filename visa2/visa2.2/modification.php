...
<body>
    ...
    <article>
        <h2>Bienvenue superuser@test.fr.</h2>	<form action="/modification.php" method="post">
		<fieldset> 
			<select id="id_nom" name="nom_etu" size="1">
				<option value="Jacques">Jacques</option><option value="Marc">Marc</option><option value="Marceline">Marceline</option><option value="Pierre">Pierre</option><option value="Luc">Luc</option><option value="Claude">Claude</option><option value="Michelle">Michelle</option><option value="Camille">Camille</option><option value="Nina">Nina</option><option value="Lucie">Lucie</option><option value="alban">alban</option><option value="JUL">JUL</option><option value="alonso">alonso</option><option value="naps">naps</option><option value="rieux">rieux</option><option value="ethan">ethan</option><option value="elvis">elvis</option><option value="Dylan">Dylan</option><option value="ninon">ninon</option><option value="hugo">hugo</option>		</select>
        ...
        <input type="submit" name="submit" value="Submit">
	        ...
	        <div id="result"></div> <!-- Ajout d'un div pour afficher le résultat -->
    </article>
    <footer>
